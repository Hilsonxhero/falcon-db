...
const handleCreate = async (values, { resetForm }) => {
    ...
    formData.append('warranty_id', data.value.warranty)
    formData.append('shipment_id', shipment.value.shipment_method)
    formData.append('weight', shipment.value.weight)
    formData.append('status', data.value.status)
    formData.append('images', JSON.stringify(data.value.image))
