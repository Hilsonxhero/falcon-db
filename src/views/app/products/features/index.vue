    ...
    <section class="mb-6">
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 lg:col-span-8">
                <HxDataTable @refresh="refresh = false" :refresh="refresh" :url="`products/${id}/features`"
                    ...
                    <template v-slot:cell-value="{ row: feature }">
                        <div class="overflow-hidden overflow-ellipsis whitespace-nowrap max-w-[10rem]">
                            {{ feature.value }}
                        </div>
                    </template>
                    ...
                    <template v-slot:cell-actions="{ row: feature, index: index }">
                        ...
                        <hx-button variant="gray" size="sm" icon
                            :to="{ name: 'products feature edit', params: { id: id, value: feature.id } }">
...
watch(() => form.value.custom, (val, oldVal) => {
