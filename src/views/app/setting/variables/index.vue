...
import Init from "@/components/app/setting/init.vue";
import Footer from "@/components/app/setting/footer.vue";
import Banners from "@/components/app/setting/banners.vue";
