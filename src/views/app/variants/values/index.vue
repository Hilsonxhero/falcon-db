    ...
    <section class="mb-6">
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 lg:col-span-8">
                <HxDataTable @refresh="refresh = false" :refresh="refresh" :url="`variant/groups/${id}/values`"
                    :single-item-index="index" search-placeholder="جستجوی  مقدار تنوع" :table-header="fields"
