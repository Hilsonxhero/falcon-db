                ...
                <Form @submit="handleUpdate" class="w-full" ref="formRef">
                    ...
                    <div class="w-full flex items-center justify-start my-4">
                        <div class="flex items-center space-x-3 space-x-reverse">
                            ...
                            <hx-button variant="light" :to="{ name: 'features values', params: { id: id } }">
                                لغو
                            </hx-button>
                        </div>
                    </div>
...
const handleUpdate = async (values, { resetForm }) => {
    ...
    try {
        const { data } = await ApiService.put(`feature/values/${feature.value}`, formData)
        resetForm();
        ...
        router.push({ name: 'features values', params: { id: id.value } })
    } catch (e) {
