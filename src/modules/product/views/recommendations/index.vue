    ...
    <section class="mb-6">
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 lg:col-span-8">
                <HxDataTable @refresh="refresh = false" :refresh="refresh" :url="`recommendations`"
                    ...
                    <div class="hx-card">
                        ...
                        <div class="hx-card__body">
                            <hx-form-group label="دسته بندی">
                                <Field name="product" rules="required" v-slot="{ field }" label="دسته بندی">
                                    <hx-select v-bind="field" remote @change="handleSelect"
                                        :remote-method="handleSearch" value-key="id" label="title"
                            ...
                            <hx-form-group label=" توضیحات">
                                <Field name="description" rules="required" v-slot="{ field }" label=" توضیحات">
                                    <hx-input type="textarea" v-bind="field" v-model="form.description"
                                        placeholder=" توضیحات">
                                    </hx-input>
                                </Field>
